...
Launch the experiment and reconstruction browser from the repository root:
...
The dashboard includes all Phase 1 experiments plus the Phase 2 and completed
Phase 3 runs used by the combined policy plots. It displays comparable coverage
and reconstruction curves and embeds interactive viewers generated by
`scripts/visualize_reconstruction.py`. It runs locally at the address printed by
